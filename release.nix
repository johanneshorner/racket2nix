...
callPackage (
  ...
  // {
    racket-packages-updated =
      runCommand "racket-packages-updated"
        rec {
          src = <racket2nix>;
          inherit racket2nix;
          buildInputs = [
        ...
        '';
    racket2nix-overlay-updated =
      runCommand "racket2nix-overlay-updated"
        {
  ...
  // lib.optionalAttrs isTravis {
    ...
    travisOrder = [
      "pkgs-all"
      "stage0-nix-prerequisites"
      "racket2nix"
      "racket-packages-updated"
      "racket2nix-overlay-updated"
      "tests.light-tests"
      "racket-full.racket2nix"
